	 ...
	 <div>
		<h2 class="summary severity{Req::val('task_severity', $task_details['task_severity'])}">
		  ...
		  <input class="text severity{Req::val('task_severity', $task_details['task_severity'])}" type="text"
			name="item_summary" size="100" maxlength="100"
		  ...
		  <table class="taskdetails">
			...
			<tr>
			 ...
			 <td>
				...
				{!tpl_options($proj->listVersions(false, null, $task_details['product_version']), Req::val('reportedver', $task_details['product_version']))}
				</select>
			 </td>
			</tr>
			<tr>
			 ...
			 <td>
				<select id="dueversion" name="closedby_version">
				 ...
				 {!tpl_options($proj->listVersions(false), Req::val('closedby_version', $task_details['closedby_version']))}
				</select>
			 </td>
			</tr>
			<tr>
